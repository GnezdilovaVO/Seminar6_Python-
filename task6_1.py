...
def progres(first_el: int, step: int, count_el: int ) -> list:
    result = list()
    # for idx in range(0, count_el):
    #     result.append(first_el + step * (idx))
    # return result
    return [(first_el + step * (idx)) for idx in range(0, count_el)]
print(progres(7, 2, 5))
print(progres(2, 3, 12))